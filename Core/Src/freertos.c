...
osThreadId J2IdentifyTaskHandle;
...
void MX_FREERTOS_Init(void) {
  ...
  osThreadDef(J2IdentifyTask, StartJ2IdentifyTask, osPriorityNormal, 0, 512);
  J2IdentifyTaskHandle = osThreadCreate(osThread(J2IdentifyTask), NULL);
  /* add threads, ... */
